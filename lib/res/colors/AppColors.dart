...
import 'package:flutter_news_app/res/colors/BaseColors.dart';
...
class AppColors implements BaseColors {
  ...
  @override
  Color get colorPrimaryText => Color.fromARGB(255, 5, 5, 5);

  @override
  Color get colorSecondaryText => Color.fromARGB(255, 90, 90, 90);
